...
The core Acquia Site Studio module can be found at https://github.com/acquia/cohesion - for full details on product setup and installation please refer to the [documentation](https://docs.acquia.com/).
...
## Documentation
Further documentation for Site Studio Content Hub is available [here](https://docs.acquia.com/6.7/user-guide/using-acquia-cohesion-acquia-content-hub).
