 ...
 */
class SitestudioImportExportTest extends SitestudioContentHubImportExportTestCase {
  ...
  protected function setUp(): void {
    ...
    $this->installSchema('cohesion', ['coh_element_schema_info']);
   ...
   */
  public static function sitestudioDataProvider() {
    yield [
      0,
      [
        [
