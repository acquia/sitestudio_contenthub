...
namespace Drupal\Tests\sitestudio_contenthub\Kernel\Stubs;
 ...
 * @group Cohesion
 *
 * @package Drupal\Tests\sitestudio_contenthub\Kernel\Stubs
 */
class SitestudioCdfExpectations extends CdfExpectations {
